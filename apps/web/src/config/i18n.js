export const translations = {
  es: {
    ...
    searchPlaceholder: 'Buscar eventos en',
    ...
    financesTitle: 'Finanzas Compartidas & Gastos del Hogar',
    financesSub: 'Gestiona cuentas claras y gastos divididos 50/50',
    splitTitle: 'Registro & División 50/50',
    expenseRegTitle: 'Registro & División de Gastos',
    expenseDescPlaceholder: 'Ej: Supermercado semanal, Pago de Luz...',
    ...
    totalExpenseLabel: 'Total acumulado en gastos',
    choresTitle: 'Organizador de Tareas del Hogar',
    randomizeBtn: 'Sortear Tareas',

    // Doc Vault
    vaultTitle: 'Bóveda de Documentos & Ficha de Salud',
    vaultSub: 'Guarda tus contratos, identificaciones y recibos en el navegador de forma segura.',
  ...
  en: {
    ...
    searchPlaceholder: 'Search events in',
    ...
    financesTitle: 'Shared Finances & Household Expenses',
    financesSub: 'Manage transparent accounts and 50/50 expense splitting',
    splitTitle: 'Shared Expense Splitter 50/50',
    expenseRegTitle: 'Expense Log & Splitter',
    expenseDescPlaceholder: 'Ex: Groceries, Electric bill...',
    ...
    totalExpenseLabel: 'Total accummulated expenses',
    choresTitle: 'Household Chore Organizer',
    randomizeBtn: 'Shuffle Chores',

    // Doc Vault
    vaultTitle: 'Document Vault & Health Card',
    vaultSub: 'Securely store contracts, IDs, and receipts locally in your browser.',
  ...
  pt: {
    ...
    searchPlaceholder: 'Buscar eventos em',
    searchBtn: 'Buscar Eventos',
    ...
    financesTitle: 'Finanças Compartilhadas & Despesas',
    financesSub: 'Gerencie contas transparentes e divisão 50/50',
    splitTitle: 'Divisão de Despesas 50/50',
    expenseRegTitle: 'Registro & Divisão de Despesas',
    expenseDescPlaceholder: 'Ex: Mercado semanal, Conta de Luz...',
    ...
    totalExpenseLabel: 'Total de despesas acumuladas',
    choresTitle: 'Organizador de Tarefas',
    randomizeBtn: 'Sortear Tarefas',

    // Doc Vault
    vaultTitle: 'Cofre de Documentos & Saúde',
    vaultSub: 'Garde contratos e recibos no seu navegador com segurança.',
